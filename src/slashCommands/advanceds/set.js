...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        const rowProduct = new ActionRowBuilder()
            .addComponents(
                new ButtonBuilder().setCustomId(idProduct).setLabel(`Comprar`).setEmoji(`<:carrinho:1218769688746528869>`).setStyle(`Success`),
                new ButtonBuilder().setURL("https://discord.com/channels/1210039548877213706/1224414793369256187").setLabel(`Dúvida`).setEmoji(`<:suporte:1223022997665746968>`).setStyle(`Link`)
            );
    
        // embed product
        const embedProduct = new EmbedBuilder()
            .setTitle(`${client.user.username} | Produto`)
            .setDescription(`**\`\`\`${descriptionP}\`\`\`\n<a:planeta:1223150948717957150> | Nome: ${nameP}\n<a:V_moneyTKF:1222739167545659413> | Preço: R$__${Number(priceP).toFixed(2)}__\n<:Caixa:1222739477424767006> | Estoque: __${estoqueP.length}__**`)
